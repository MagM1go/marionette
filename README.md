...
- `application/protocols.py` - протоколы репозиториев. Возможно, будет раздроблено, однако сейчас в этом нет нужды.
...
- `infrastructure/repositories` - так сказать удочки, которые достают всю нужную информацию из БД. Реализованы на базе `protocols.py`
