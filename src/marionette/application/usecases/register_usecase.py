...
class RegisterUseCase:
    ...
    async def register(self, user_id: UserId, name: str, role: Roles, birthday: datetime, biography: str, gender: CharacterGender) -> CharacterId:
        async with self._transaction:
            ...
            character = self._repository.create(user_id=user_id, name=name, role=role, birthday=birthday, biography=biography, gender=gender)
