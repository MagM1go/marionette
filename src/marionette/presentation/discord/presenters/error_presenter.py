...
_MESSAGES: dict[type, str] = {
    ...
    exc.CharacterIsViewer: "Зрителю место в местах наблюдателей.",
    exc.AlreadySubscribed: "Вы уже подписаны на этого персонажа.",
    exc.CanNotSubscribeYourself: "Нельзя подписаться на самого себя.",
